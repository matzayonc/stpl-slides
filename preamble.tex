...
\setbeamercolor{frametitle}{fg=stplwhite, bg=stpldark}
\setbeamerfont{frametitle}{size=\large, series=\bfseries}
\setbeamertemplate{frametitle}{%
  \vspace{0.35cm}%
  \insertframetitle\par
  \nointerlineskip\vspace{0.18cm}%
  {\color{stplred}\rule{2.2cm}{1.5pt}}%
}

%% ---- Progress bar at top of every slide ----
...
\AtBeginSection[]{%
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture, overlay]
      \fill[stpldark] (current page.south west) rectangle (current page.north east);
