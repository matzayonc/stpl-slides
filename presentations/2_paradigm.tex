...
\begin{frame}{Z wizji do warsztatu}
  \begin{itemize}
    \item Poprzednia lekcja pokazała \textbf{co} powstaje na Solanie
    \item Teraz pytanie zmienia się na \textbf{jak} pracuje dev Web3
...
\begin{frame}{Podsumowanie}
  ...
  \vspace{0.4cm}
  \begin{center}
    \textcolor{stplmuted}{Wiesz \textbf{JAK} pracuje Web3 dev.
    Od kolejnej lekcji --- w jakim języku.}
  \end{center}
\end{frame}
